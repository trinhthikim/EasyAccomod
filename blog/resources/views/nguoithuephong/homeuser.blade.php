                        ...
                        <div class="uk-card uk-card-default home__block__tintuc__card uk-card-hover ">
                            ...
                            <div class="uk-card-body uk-padding-small ">
                                ...
                                <div class="uk-text-right "> 
                                    <a href="/blog/public/nguoithuephong/baidang/{{$row->id}}" class="home__block__tintuc__card__readMore uk-icon " uk-icon="icon: chevron-right ">Xem thêm</a> </div>
                            </div>
                        </div>
                    </div> 
                @endforeach </div>
    ...
    <div class="uk-section uk-background-bottom-center uk-background-norepeat ">
        <div class="uk-container uk-container-small ">
            <div class="uk-text-center trainghiem__box1 ">
                ...
                <div class="home__block__lienhe__desc uk-margin ">Nếu có bát kì thắc mắc nào hãy liên hệ trực tiếp với
                    chúng tôi
                    <br> và còn nhiều hơn thế nữa</div>
                <a href="#tuvanngay " class="home__block2__btn uk-button uk-button-default uk-border-pill ">NHẬN TƯ VẤN
                    NGAY</a>
            </div>
        </div>
    </div>
