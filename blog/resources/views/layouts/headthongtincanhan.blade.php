...
<title>Thông tin cá nhân</title>
    ...
    <meta name="_token" content="8PW1m1Q2pJa0aHuGOJUoA1xyDCZR1NWBjfZAKlab">
    ...
    <script type="text/javascript" async="" src="{{asset('asset/javascript/analytics.js.download')}}"></script>
    <script async="" src="{{asset('asset/javascript/default')}}" charset="UTF-8" crossorigin="*"></script>
    <script type="text/javascript">
    ...
    <script async="" src="{{asset('asset/javascript/js')}}"></script>
    <script>
