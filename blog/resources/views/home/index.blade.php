...
<body>
    <div ip="app" class="uk-height-viewport uk-offcanvas-content uk-overflow-hidden">
                    ...
                    <div class="uk-navbar-right uk-padding-remove">
                        ...
                        <div class="uk-navbar-item topHeader__item topHeader__item--loginBox">
                            ...
                            <span class="uk-text-middle">
                                <a href="/blog/public/login"> Đăng nhập</a> / 
                                <a href="/blog/public/signin">Đăng ký</a>
                            </span>
                        </div>
                    </div>
                </nav>
                ...
                <nav class="uk-navbar-container uk-navbar-transparent uk-navbar" uk-navbar="">
                    <div class="uk-navbar-left">
                        ...
                        <a href="http://ql.xephinh.xyz/" class="uk-navbar-item uk-padding-remove uk-logo">
                            <img src="./asset/image/EasyAccomod.png" alt="logo">
                        </a>
                    </div>
                    <div class="uk-navbar-right">
                        <ul class="uk-navbar-nav uk-visible@m">
                            <li>
                                <a href="" style="font-size: small;">TRANG CHỦ</a>
                            </li>
                            <li>
            ...
            <div class="uk-overflow-auto uk-offcanvas-bar uk-padding-remove uk-flex uk-flex-column">
                <div class="uk-flex-auto">
                    ...
                    <ul class="uk-nav-default uk-nav uk-nav-parent-icon nav__menu" uk-nav>
                        <li class="nav__menu__item"><a href="">TRANG CHỦ</a></li>
        ...
        <div class="uk-position-relative uk-visible-toggle uk-light uk-slideshow" tabindex="-1" uk-slideshow="ratio: 16:9; autoplay: true; autoplay-interval: 4000">
            <ul class="uk-slideshow-items" uk-height-viewport="offset-top: true; offset-bottom: 0" style="min-height: calc(100vh - 120px);">
                <li tabindex="-1" class="">
                    <img src="./asset/image/banner-1.JPG" alt="" uk-cover="" class="uk-cover" style="height: 650px; width: 1306px;">
                </li>
                ...
                <li tabindex="-1" class="">
                    <img src="./asset/image/banner-3.JPG" alt="" uk-cover="" class="uk-cover" style="height: 650px; width: 1306px;">
                </li>
                <li tabindex="-1" class="">
                    <img src="./asset/image/banner-4.JPG" alt="" uk-cover="" class="uk-cover" style="height: 650px; width: 1306px;">
                </li>
            </ul>

            <a class="uk-position-center-left uk-position-small uk-hidden-hover uk-icon uk-slidenav-previous uk-slidenav" href="http://ql.xephinh.xyz/#" uk-slidenav-previous="" uk-slideshow-item="previous"></a>
            <a class="uk-position-center-right uk-position-small uk-hidden-hover uk-icon uk-slidenav-next uk-slidenav" href="http://ql.xephinh.xyz/#" uk-slidenav-next="" uk-slideshow-item="next"></a>

        </div>
        <!-- Phần tra cứu. Phần code hơi xấu và dài do chưa có thời gian chỉnh sửa -->
        <div class="home__block__tracuu" id="tracuu">
            <div class="home__block__tracuu__bg uk-background-norepeat uk-section uk-background-center-center" data-src="" uk-img="">
                <div class="uk-container">
                    <div class="home__title uk-text-center uk-text-uppercase uk-margin-medium"><span>TRA CỨU BẢN TIN TẠI ĐÂY</span></div>
                                        ...
                                        <div class="uk-card-body uk-padding-small">
                                            <form action="" method="post" class="uk-grid-small uk-grid" uk-grid="">
                                                ...
                                                <div class="uk-width-1-5 uk-grid-margin">
                                                    <label class="uk-form-label tracuu__card1__label" for="form-stacked-text">Chọn tin</label>
                                                    <div class="uk-form-controls">
                                                        <div class="uk-width-1-1 uk-form-custom" uk-form-custom="target: &gt; * &gt; span:first-child">
                                                            <select name="loaidichvu">
                                                                <option value="Phòng trọ">Thuê phòng trọ</option>
                                                                <option value="chung cư mini">Thuê chung cư mini</option>
                                                                <option value="Nhà nguyên căn">Thuê nhà nguyên căn</option>
                                                                <option value="Chung cư nguyên căn">Thuê chung cư nguyên căn</option>
                                                            </select>
                                                ...
                                                <div class="uk-width-1-5 uk-first-column">
                                                    <label class="uk-form-label tracuu__card1__label" for="form-stacked-text">Chọn Tỉnh/TP</label>
                                                    <div class="uk-form-controls">
                                                        <div class="uk-child-width-1-1 uk-grid-10 uk-grid uk-grid-stack" uk-grid="">
                                                            <div class="uk-first-column">
                                                                <div class="tinhnhan uk-form-custom" id="558" style="display: block" uk-form-custom="target: &gt; * &gt; span:first-child">
                                                                    ...
                                                                    <button class="uk-button uk-button-default uk-width-1-1 uk-border-rounded tracuu__card1__select" type="button" tabindex="-1">
                                                                        <span>An Giang</span>
                                                                        <span uk-icon="icon: menu" class="uk-icon"><svg width="20" height="20" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" data-svg="menu"><rect x="2" y="4" width="16" height="1"></rect><rect x="2" y="9" width="16" height="1"></rect><rect x="2" y="14" width="16" height="1"></rect></svg></span>
                                                                    </button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="uk-width-1-5 uk-grid-margin">
                                                    <label class="uk-form-label tracuu__card1__label" for="form-stacked-text">Chọn Quận/Huyện</label>
                                                    <div class="uk-form-controls">
                                                        <div class="uk-width-1-1 uk-form-custom" uk-form-custom="target: &gt; * &gt; span:first-child">
                                                            <div class="uk-grid-margin uk-first-column">
                                                                <div id="tmp2" class="uk-width-1-1 uk-form-custom" uk-form-custom="target: &gt; * &gt; span:first-child">
                                                                ...
                                                                <div id="601" style="display: none" class="uk-width-1-1 uk-form-custom" uk-form-custom="target: &gt; * &gt; span:first-child">
                                                                ...
                                                                <div id="602" style="display: none" class="uk-width-1-1 uk-form-custom" uk-form-custom="target: &gt; * &gt; span:first-child">
                                                                    <select name="huyen_nhan[]">
                                                                ...
                                                                <div id="603" style="display: none" class="uk-width-1-1 uk-form-custom" uk-form-custom="target: &gt; * &gt; span:first-child">
                                                                    <select name="huyen_nhan[]">
                                                                ...
                                                                <div id="604" style="display: none" class="uk-width-1-1 uk-form-custom" uk-form-custom="target: &gt; * &gt; span:first-child">
                                                                    <select name="huyen_nhan[]">
                                                                ...
                                                                <div id="605" style="display: none" class="uk-width-1-1 uk-form-custom" uk-form-custom="target: &gt; * &gt; span:first-child">
                                                                    <select name="huyen_nhan[]">
                                                                ...
                                                                <div id="606" style="display: none" class="uk-width-1-1 uk-form-custom" uk-form-custom="target: &gt; * &gt; span:first-child">
                                                                    <select name="huyen_nhan[]">
                                                                ...
                                                                <div id="607" style="display: none" class="uk-width-1-1 uk-form-custom" uk-form-custom="target: &gt; * &gt; span:first-child">
                                                                    <select name="huyen_nhan[]">
                                                                ...
                                                                <div id="608" style="display: none" class="uk-width-1-1 uk-form-custom" uk-form-custom="target: &gt; * &gt; span:first-child">
                                                                    <select name="huyen_nhan[]">
                                                                ...
                                                                <div id="609" style="display: none" class="uk-width-1-1 uk-form-custom" uk-form-custom="target: &gt; * &gt; span:first-child">
                                                                    <select name="huyen_nhan[]">
                                                                ...
                                                                <div id="610" style="display: none" class="uk-width-1-1 uk-form-custom" uk-form-custom="target: &gt; * &gt; span:first-child">
                                                                    <select name="huyen_nhan[]">
                                                                ...
                                                                <div id="611" style="display: none" class="uk-width-1-1 uk-form-custom" uk-form-custom="target: &gt; * &gt; span:first-child">
                                                                    <select name="huyen_nhan[]">
                                                                ...
                                                                <div id="612" style="display: none" class="uk-width-1-1 uk-form-custom" uk-form-custom="target: &gt; * &gt; span:first-child">
                                                                    <select name="huyen_nhan[]">
                                                                ...
                                                                <div id="613" style="display: none" class="uk-width-1-1 uk-form-custom" uk-form-custom="target: &gt; * &gt; span:first-child">
                                                                    <select name="huyen_nhan[]">
                                                                ...
                                                                <div id="614" style="display: none" class="uk-width-1-1 uk-form-custom" uk-form-custom="target: &gt; * &gt; span:first-child">
                                                                    <select name="huyen_nhan[]">
                                                                ...
                                                                <div id="615" style="display: none" class="uk-width-1-1 uk-form-custom" uk-form-custom="target: &gt; * &gt; span:first-child">
                                                                    <select name="huyen_nhan[]">
                                                                ...
                                                                <div id="616" style="display: none" class="uk-width-1-1 uk-form-custom" uk-form-custom="target: &gt; * &gt; span:first-child">
                                                                    <select name="huyen_nhan[]">
                                                                ...
                                                                <div id="617" style="display: none" class="uk-width-1-1 uk-form-custom" uk-form-custom="target: &gt; * &gt; span:first-child">
                                                                    <select name="huyen_nhan[]">
                                                                ...
                                                                <div id="618" style="display: none" class="uk-width-1-1 uk-form-custom" uk-form-custom="target: &gt; * &gt; span:first-child">
                                                                    <select name="huyen_nhan[]">
                                                                ...
                                                                <div id="619" style="display: none" class="uk-width-1-1 uk-form-custom" uk-form-custom="target: &gt; * &gt; span:first-child">
                                                                    <select name="huyen_nhan[]">
                                                                ...
                                                                <div id="620" style="display: none" class="uk-width-1-1 uk-form-custom" uk-form-custom="target: &gt; * &gt; span:first-child">
                                                                    <select name="huyen_nhan[]">
                                                                ...
                                                                <div id="621" style="display: none" class="uk-width-1-1 uk-form-custom" uk-form-custom="target: &gt; * &gt; span:first-child">
                                                                    <select name="huyen_nhan[]">
                                                                ...
                                                                <div id="622" style="display: none" class="uk-width-1-1 uk-form-custom" uk-form-custom="target: &gt; * &gt; span:first-child">
                                                                    <select name="huyen_nhan[]">
                                                                ...
                                                                <div id="623" style="display: none" class="uk-width-1-1 uk-form-custom" uk-form-custom="target: &gt; * &gt; span:first-child">
                                                                    <select name="huyen_nhan[]">
                                                                ...
                                                                <div id="624" style="display: none" class="uk-width-1-1 uk-form-custom" uk-form-custom="target: &gt; * &gt; span:first-child">
                                                                    <select name="huyen_nhan[]">
                                                                ...
                                                                <div id="625" style="display: none" class="uk-width-1-1 uk-form-custom" uk-form-custom="target: &gt; * &gt; span:first-child">
                                                                    <select name="huyen_nhan[]">
                                                                ...
                                                                <div id="626" style="display: none" class="uk-width-1-1 uk-form-custom" uk-form-custom="target: &gt; * &gt; span:first-child">
                                                                    <select name="huyen_nhan[]">
                                                                ...
                                                                <div id="627" style="display: none" class="uk-width-1-1 uk-form-custom" uk-form-custom="target: &gt; * &gt; span:first-child">
                                                                    <select name="huyen_nhan[]">
                                                                ...
                                                                <div id="628" style="display: none" class="uk-width-1-1 uk-form-custom" uk-form-custom="target: &gt; * &gt; span:first-child">
                                                                    <select name="huyen_nhan[]">
                                                                ...
                                                                <div id="629" style="display: none" class="uk-width-1-1 uk-form-custom" uk-form-custom="target: &gt; * &gt; span:first-child">
                                                                    <select name="huyen_nhan[]">
                                                                ...
                                                                <div id="630" style="display: none" class="uk-width-1-1 uk-form-custom" uk-form-custom="target: &gt; * &gt; span:first-child">
                                                                    <select name="huyen_nhan[]">
                                                                ...
                                                                <div id="631" style="display: none" class="uk-width-1-1 uk-form-custom" uk-form-custom="target: &gt; * &gt; span:first-child">
                                                                    <select name="huyen_nhan[]">
                                                                ...
                                                                <div id="632" style="display: none" class="uk-width-1-1 uk-form-custom" uk-form-custom="target: &gt; * &gt; span:first-child">
                                                                    <select name="huyen_nhan[]">
                                                                ...
                                                                <div id="633" style="display: none" class="uk-width-1-1 uk-form-custom" uk-form-custom="target: &gt; * &gt; span:first-child">
                                                                    <select name="huyen_nhan[]">
                                                                ...
                                                                <div id="634" style="display: none" class="uk-width-1-1 uk-form-custom" uk-form-custom="target: &gt; * &gt; span:first-child">
                                                                    <select name="huyen_nhan[]">
                                                                ...
                                                                <div id="635" style="display: none" class="uk-width-1-1 uk-form-custom" uk-form-custom="target: &gt; * &gt; span:first-child">
                                                                    <select name="huyen_nhan[]">
                                                                ...
                                                                <div id="636" style="display: none" class="uk-width-1-1 uk-form-custom" uk-form-custom="target: &gt; * &gt; span:first-child">
                                                                    <select name="huyen_nhan[]">
                                                                ...
                                                                <div id="637" style="display: none" class="uk-width-1-1 uk-form-custom" uk-form-custom="target: &gt; * &gt; span:first-child">
                                                                    <select name="huyen_nhan[]">
                                                                ...
                                                                <div id="638" style="display: none" class="uk-width-1-1 uk-form-custom" uk-form-custom="target: &gt; * &gt; span:first-child">
                                                                    <select name="huyen_nhan[]">
                                                                ...
                                                                <div id="639" style="display: none" class="uk-width-1-1 uk-form-custom" uk-form-custom="target: &gt; * &gt; span:first-child">
                                                                    <select name="huyen_nhan[]">
                                                                ...
                                                                <div id="640" style="display: none" class="uk-width-1-1 uk-form-custom" uk-form-custom="target: &gt; * &gt; span:first-child">
                                                                    <select name="huyen_nhan[]">
                                                                ...
                                                                <div id="641" style="display: none" class="uk-width-1-1 uk-form-custom" uk-form-custom="target: &gt; * &gt; span:first-child">
                                                                    <select name="huyen_nhan[]">
                                                                ...
                                                                <div id="642" style="display: none" class="uk-width-1-1 uk-form-custom" uk-form-custom="target: &gt; * &gt; span:first-child">
                                                                    <select name="huyen_nhan[]">
                                                                ...
                                                                <div id="643" style="display: none" class="uk-width-1-1 uk-form-custom" uk-form-custom="target: &gt; * &gt; span:first-child">
                                                                    <select name="huyen_nhan[]">
                                                                ...
                                                                <div id="644" style="display: none" class="uk-width-1-1 uk-form-custom" uk-form-custom="target: &gt; * &gt; span:first-child">
                                                                    <select name="huyen_nhan[]">
                                                                ...
                                                                <div id="645" style="display: none" class="uk-width-1-1 uk-form-custom" uk-form-custom="target: &gt; * &gt; span:first-child">
                                                                    <select name="huyen_nhan[]">
                                                                ...
                                                                <div id="646" style="display: none" class="uk-width-1-1 uk-form-custom" uk-form-custom="target: &gt; * &gt; span:first-child">
                                                                    <select name="huyen_nhan[]">
                                                                ...
                                                                <div id="647" style="display: none" class="uk-width-1-1 uk-form-custom" uk-form-custom="target: &gt; * &gt; span:first-child">
                                                                    <select name="huyen_nhan[]">
                                                                ...
                                                                <div id="648" style="display: none" class="uk-width-1-1 uk-form-custom" uk-form-custom="target: &gt; * &gt; span:first-child">
                                                                    <select name="huyen_nhan[]">
                                                                ...
                                                                <div id="649" style="display: none" class="uk-width-1-1 uk-form-custom" uk-form-custom="target: &gt; * &gt; span:first-child">
                                                                    <select name="huyen_nhan[]">
                                                                ...
                                                                <div id="650" style="display: none" class="uk-width-1-1 uk-form-custom" uk-form-custom="target: &gt; * &gt; span:first-child">
                                                                    <select name="huyen_nhan[]">
                                                                                                                                                                                                                    <option value="1">Châu Thành</option>
                                                                ...
                                                                <div id="651" style="display: none" class="uk-width-1-1 uk-form-custom" uk-form-custom="target: &gt; * &gt; span:first-child">
                                                                    <select name="huyen_nhan[]">
                                                                ...
                                                                <div id="652" style="display: none" class="uk-width-1-1 uk-form-custom" uk-form-custom="target: &gt; * &gt; span:first-child">
                                                                    <select name="huyen_nhan[]">
                                                                ...
                                                                <div id="653" style="display: none" class="uk-width-1-1 uk-form-custom" uk-form-custom="target: &gt; * &gt; span:first-child">
                                                                    <select name="huyen_nhan[]">
                                                                ...
                                                                <div id="654" style="display: none" class="uk-width-1-1 uk-form-custom" uk-form-custom="target: &gt; * &gt; span:first-child">
                                                                    <select name="huyen_nhan[]">
                                                                ...
                                                                <div id="655" style="display: none" class="uk-width-1-1 uk-form-custom" uk-form-custom="target: &gt; * &gt; span:first-child">
                                                                    <select name="huyen_nhan[]">
                                                                ...
                                                                <div id="656" style="display: none" class="uk-width-1-1 uk-form-custom" uk-form-custom="target: &gt; * &gt; span:first-child">
                                                                    <select name="huyen_nhan[]">
                                                                ...
                                                                <div id="657" style="display: none" class="uk-width-1-1 uk-form-custom" uk-form-custom="target: &gt; * &gt; span:first-child">
                                                                    <select name="huyen_nhan[]">
                                                                ...
                                                                <div id="658" style="display: none" class="uk-width-1-1 uk-form-custom" uk-form-custom="target: &gt; * &gt; span:first-child">
                                                                    <select name="huyen_nhan[]">
                                                                ...
                                                                <div id="659" style="display: none" class="uk-width-1-1 uk-form-custom" uk-form-custom="target: &gt; * &gt; span:first-child">
                                                                    <select name="huyen_nhan[]">
                                                                ...
                                                                <div id="660" style="display: none" class="uk-width-1-1 uk-form-custom" uk-form-custom="target: &gt; * &gt; span:first-child">
                                                                    <select name="huyen_nhan[]">
                                                                ...
                                                                <div id="661" style="display: none" class="uk-width-1-1 uk-form-custom" uk-form-custom="target: &gt; * &gt; span:first-child">
                                                                    <select name="huyen_nhan[]">
                                                                ...
                                                                <div id="662" style="display: none" class="uk-width-1-1 uk-form-custom" uk-form-custom="target: &gt; * &gt; span:first-child">
                                                                    <select name="huyen_nhan[]">
                                                                ...
                                                                <div id="663" style="display: none" class="uk-width-1-1 uk-form-custom" uk-form-custom="target: &gt; * &gt; span:first-child">
                                                                    <select name="huyen_nhan[]">
                                                ...
                                                <div class="uk-width-1-5 uk-grid-margin">
                                                    <label class="uk-form-label tracuu__card1__label" for="form-stacked-text">Giá cả</label>
                                                    <div class="uk-form-controls">
                                                        <div class="uk-width-1-1 uk-form-custom" uk-form-custom="target: &gt; * &gt; span:first-child">
                                                            <select name="gia_ca">
                                                                ...
                                                                <option value="5 triệu - 10 triệu">5 triệu - 10 triệu</option>
                                                                <option value="10 triệu - 50 triệu">10 triệu - 50 triệu</option>
                                                ...
                                                <div class="uk-width-1-5 uk-grid-margin">
                                                    <label class="uk-form-label tracuu__card1__label" for="form-stacked-text">Diện tích</label>
                                                    <div class="uk-form-controls">
                                                        <div class="uk-width-1-1 uk-form-custom" uk-form-custom="target: &gt; * &gt; span:first-child">
                                                            <select name="dien_tich">
                                                                <option>Chọn diện tích (m2)</option>
                                                                <option value="Dưới 20 m2">Dưới 20 m2</option>
                                                                <option value="20 m2 - 30 m2">20 m2 - 30 m2</option>
                                                                <option value="30 m2 - 50 m2">30 m2 - 50 m2</option>
                                                                <option value="50 m2 - 100 m2">50 m2 - 100 m2</option>
                                                                <option value="Trên 100 m2">Trên 100 m2</option>>
                                                            </select>
                                                            <button class="uk-button uk-button-default uk-width-1-1 uk-border-rounded tracuu__card1__select" type="button" tabindex="-1">
                                                                <span></span>
                                                                <span uk-icon="icon: menu" class="uk-icon"></span>
                                                ...
                                                <div class="uk-width-1-1 uk-grid-margin">
                                                    <label class="uk-form-label tracuu__card1__label" for="form-stacked-text">ĐIỀU KIỆN CƠ SỞ VẬT CHẤT</label>
                                                    <div class="uk-form-controls">
                                                        <div class="uk-width-1-1 uk-form-custom" uk-form-custom="target: &gt; * &gt; span:first-child">

                                                            <div class="uk-form-label tracuu__card1__label uk-margin-small">
                                                                <label for="" style="float: left; width: 80px;">Phòng tắm:</label>
                                                                <label><input class="uk-radio" type="radio" name="radio1" style="width: 10px;height: 10px; margin-left: 20px;" value="khép kín"> khép kín</label>
                                                            ...
                                                            <div class="uk-form-label tracuu__card1__label uk-margin-small">
                                                                ...
                                                                <label><input class="uk-radio" type="radio" name="radio3" style="width: 10px;height: 10px; margin-left: 20px;" value="không được nấu ăn"> không được nấu ăn</label>
                                                            </div>
                                                            <div class="uk-form-label tracuu__card1__label uk-margin-small">
        ...
        <div class="uk-section " style="padding: 5px 0 10px 0; ">
            <div class="uk-container ">
                ...
                <div class="uk-margin home__block__lienhe__desc uk-text-center " style="color: #b8b6b6; padding-top: 10px; ">
        ...
        <div class="uk-section " id="baidang">
        <div class="uk-container ">
                ...
                <div>
                    <div class="uk-card uk-card-default home__block__tintuc__card uk-card-hover ">
                        <div class="uk-cover-container ">
                            <a href="http://ql.xephinh.xyz/dich-vu/gia-cuoc-van-chuyen-nhanh ">
                                <img src= "./anhphongtro/{{$row->anh1}}" class="uk-cover " uk-cover=" ">
                                <Canvas width="600 " height="400 "></Canvas>
                            </a>
                        </div>
                        
                        <div class="uk-card-body uk-padding-small ">
                            <div class="home__block__tintuc__card__dm uk-text-large uk-text-uppercase ">
                                {{$row->diachi}}, {{$row->quan}}, {{$row->thanhpho}}
                            </div>
                            <div class="home__block__tintuc__card__title " stype="color: #727171 ">
                                Giá Thuê: {{$row->giaca}} Đ
                                <!-- <span class="uk-icon " uk-icon="icon:hashtag; ratio:0.7 "></span> : 58 -->
                            </div>
                            <div class="home__block__tintuc__card__time ">
                                <span class="uk-icon " uk-icon="icon: clock; ratio:0.7 "></span> 2020-07-18 20:51:07
                            </div>
                            <div class="uk-text-right ">
                                <a href="/blog/public/baidang/{{$row->id}}" class="home__block__tintuc__card__readMore uk-icon "
                                    uk-icon="icon: chevron-right ">Xem thêm</a>
                            </div>      
                        </div>
                    </div>
                </div>
        ...
        <!-- Phần để cho đẹp chưa chỉnh đc -->
        <div class="uk-section uk-background-bottom-center uk-background-norepeat ">
            <div class="uk-container uk-container-small ">
                <div class="uk-text-center trainghiem__box1 ">
                    <div class="trainghiem__box1__title ">Thử trải nghiệm dịch vụ hoàn toàn khác</div>
                    <div class="home__block__lienhe__desc uk-margin ">Nếu có bát kì thắc mắc nào hãy liên hệ trực tiếp với chúng tôi
