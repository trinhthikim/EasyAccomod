...
<main role="main" class="ml-sm-auto col-lg-10">
    ...
    <form class="js-form-submit-data" action="" data-action-url="#" method="POST" novalidate="novalidate">
        ...
        <div class="form-group row mt-5">
            ...
            <div class="col-md-6">
                <input type="text" class="form-control valid" id="user_name" name="name" value=""
                    placeholder="trannhung">
            </div>
        </div>
        ...
        <div class="form-group row mt-5">
            ...
            <div class="col-md-6">
                <input type="text" class="form-control valid" id="user_name" name="hoten" value=""
                    placeholder="Nguyễn Văn A" aria-invalid="false">
            </div>
        </div>
        <div class="form-group row">
            <label for="user_email" class="col-md-2 offset-md-2 col-form-label">Số điện thoại</label>
            <div class="col-md-6">
                <input type="text" class="form-control" id="user_email" name="sodienthoai" value=""
        ...
        <div class="form-group row">
            ...
            <div class="col-md-6">
                <input type="text" class="form-control" id="user_email" name="socmnd" value=""
        ...
        <div class="form-group row">
            ...
            <div class="col-md-6">
                <input type="text" class="form-control" id="user_email" name="diachi" value=""
                    placeholder="nhập đủ xã/ huyện/ tỉnh">
            </div>
        </div>
        <div class="form-group row mt-5">
