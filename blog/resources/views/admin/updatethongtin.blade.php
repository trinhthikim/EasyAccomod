                ...
                <main role="main" class="ml-sm-auto col-lg-10">
                    ...
                    <form class="js-form-submit-data" action="" data-action-url="#" method="POST" novalidate="novalidate">
                        ...
                        <div class="form-group row mt-5">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control valid" id="user_name" name="name" value="" placeholder="trannhung">
                            </div>
                        </div>

                        <div class="form-group row mt-5">
                            <label for="user_name" class="col-md-2 offset-md-2 col-form-label">Họ và tên</label>
                            <div class="col-md-6">
                                <input type="text" class="form-control valid" id="user_name" name="hoten" value="" placeholder="Nguyễn Văn A" aria-invalid="false">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="user_email" class="col-md-2 offset-md-2 col-form-label">Số điện thoại</label>
                            <div class="col-md-6">
                                <input type="text" class="form-control" id="user_email" name="sodienthoai" value="" placeholder="Nhập số điện thoại">
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control" id="user_email" name="socmnd" value="" placeholder="nhập số căn cước">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="user_email" class="col-md-2 offset-md-2 col-form-label">Địa chỉ thường chú</label>
                            <div class="col-md-6">
                                <input type="text" class="form-control" id="user_email" name="diachi" value="" placeholder="nhập đủ xã/ huyện/ tỉnh">
                            </div>
                        </div>
                        <div class="form-group row mt-5">
                            <label for="user_email" class="col-md-2 col-form-label"></label>
                            <div class="col-md-8">
                                <button type="submit" class="btn btn-primary mb-2 btn-block">Lưu</button>
                            </div>
                        </div>
                    </form>
                    <footer>
