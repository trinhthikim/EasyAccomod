                ...
                <nav class="uk-navbar-container uk-navbar-transparent uk-navbar" uk-navbar="">
                    ...
                    <div class="uk-navbar-right">
                        <ul class="uk-navbar-nav uk-visible@m">
                            ...
                            <li>
                                <a href="./index.html/#tracuu" style="font-size: small">TRA CỨU</a>
                            </li>
                            <li>
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <nav class="col-lg-2 d-none d-lg-block bg-light sidebar" style="margin-top: 75px;">
                    <div class="user_info">
                        <a href="/blog/public/admin/thongtincanhan" class="clearfix">
                        ...
                        <!-- <a class="btn btn-danger btn-sm" href="./Đăng tin mới.html">Đăng tin</a>
                        <a href="#" class="btn btn-warning btn-sm mr-1">Thông báo</a> -->
                    </div>
                    <ul class="nav nav-sidebar">
                        <li class="nav-item">
                            <a class="nav-link" href="/blog/public/admin/quanlytaikhoan">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-file-text"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="16" y1="13" x2="8" y2="13"></line><line x1="16" y1="17" x2="8" y2="17"></line><polyline points="10 9 9 9 8 9"></polyline></svg>                                Quản lý tài khoản chủ trọ
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link active" href="/blog/public/admin/quanlybaidang">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path></svg>                                Quản lý bài đăng
                            </a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link " href="/blog/public/admin/thongtincanhan">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-calendar"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"></rect><line x1="16" y1="2" x2="16" y2="6"></line><line x1="8" y1="2" x2="8" y2="6"></line><line x1="3" y1="10" x2="21" y2="10"></line></svg>                                Thông tin Admin
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link " href="/blog/public/admin/dschutro">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-clipboard"><path d="M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2"></path><rect x="8" y="2" width="8" height="4" rx="1" ry="1"></rect></svg>                                Chat
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link " href="/blog/public/admin/thongke">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-calendar"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"></rect><line x1="16" y1="2" x2="16" y2="6"></line><line x1="8" y1="2" x2="8" y2="6"></line><line x1="3" y1="10" x2="21" y2="10"></line></svg>                                Thống kê, phân tích xu hướng thị hiếu
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="/blog/public/admin/doimatkhau/{{Auth::user()->id}}">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="/blog/public/admin/quanlycomment">

                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-log-out"><path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"></path><polyline points="16 17 21 12 16 7"></polyline><line x1="21" y1="12" x2="9" y2="12"></line></svg>                               Quản lý comment
                            </a>
                        </li>
